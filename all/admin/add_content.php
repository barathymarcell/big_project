							...
							<!-- block -->
		                        <div class="block">
		                            <div class="navbar navbar-inner block-header">
		                                <div class="muted pull-left">Tartalom hozzáadása</div>
		                            </div>
									...
									<a href="content.php"><i class="icon-arrow-left"></i> Visszalépés</a>
									   ...
									   <form class="form-horizontal" method="POST">
										...
										<div class="controls">
										<input type="text" name="title" id="inputEmail" placeholder="Cím">
										</div>
										</div>
										...
										<button name="save" type="submit" class="btn btn-info"><i class="icon-save icon-large"></i> Mentés</button>
										</div>
										</div>
										</form>
