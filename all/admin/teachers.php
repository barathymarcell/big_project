                     ...
                     <div class="row-fluid">
                        ...
                        <div id="block_bg" class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left">Oktatók listája</div>
                            </div>
                            <div class="block-content collapse in">
                                <div class="span12">
									...
									<td width="120"><a href="de_activate.php<?php echo '?id='.$id; ?>" class="btn btn-danger"><i class="icon-remove"></i> Passzív</a></td>
									<?php }else{ ?>
									<td width="120"><a href="edit_teacher.php<?php echo '?id='.$id; ?>" class="btn btn-success"><i class="icon-check"></i> Aktív</a></td>
									<?php } ?>
                                </tr>
                            <?php } ?>
