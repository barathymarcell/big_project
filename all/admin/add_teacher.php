   <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left">Oktató hozzáadása</div>
                            </div>
                            <div class="block-content collapse in">
								...
								<form method="post">
										...
										<div class="control-group">
                                          <div class="controls">
                                            <input class="input focused" name="firstname" id="focusedInput" type="text" placeholder = "Vezetéknév">
                                          </div>
                                        </div>
										
										<div class="control-group">
                                          <div class="controls">
                                            <input class="input focused" name="lastname" id="focusedInput" type="text" placeholder = "Keresztnév">
                                          </div>
                                        </div>
					    ...
					    <?php
                            if (isset($_POST['save'])) {
								...
								if ($count > 0){ ?>
								<script>
								alert('Már rögzítve van ilyen adat!');
								</script>
								<?php
								}else{
