                    ...
                    <div class="row-fluid">
                        ...
                        <div id="block_bg" class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left">Adatszámok</div>
                            </div>
                            <div class="block-content collapse in">
                                ...
                                <div class="span3">
                                    ...
                                    <div class="chart-bottom-heading"><strong>Regisztrált oktatók</strong>
                                ...
                                <div class="span3">
                                    ...
                                    <div class="chart-bottom-heading"><strong>Oktatók</strong>
                                ...
                                <div class="span3">
                                    ...
                                    <div class="chart-bottom-heading"><strong>Regisztrált hallgatók</strong>
                                ...
                                <div class="span3">
                                    <div class="chart" data-percent="<?php echo $count_student ?>"><?php echo $count_student ?></div>
                                    <div class="chart-bottom-heading"><strong>Hallgatók</strong>
                                ...
                                <div class="span3">
                                    ...
                                    <div class="chart-bottom-heading"><strong>Csoport</strong>
                                ...
                                <div class="span3">
                                    ...
                                    <div class="chart-bottom-heading"><strong>Letölthető elemek</strong>
                                ...
                                <div class="span3">
                                    ...
                                    <div class="chart-bottom-heading"><strong>Tantárgyak</strong>
