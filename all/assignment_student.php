                     ...
                     <div class="row-fluid">
					   ...
					   <!-- breadcrumb -->
					     ...
					     <ul class="breadcrumb">
							...
							<li><a href="#"><b>Feltöltött feladatok</b></a></li>
						</ul>
						 <!-- end breadcrumb -->
                        ...
                        <div id="block_bg" class="block">
                            ...
                            <div class="block-content collapse in">
								...
								<?php
									...
									$count = mysqli_num_rows($query);
									if ($count == '0'){?>
									<div class="alert alert-info">Jelenleg nincs feltöltött feladat.</div>
									<?php
									}else{
								?>
									...
									?>                              
										...
										<?php } ?>
										 <button  data-placement="bottom" title="Feladat elküldése" id="<?php echo $id; ?>submit" class="btn btn-success" name="btn_assign"><i class="icon-upload icon-large"></i> Feladat elküldése</button>
										 </form>
										 </td>                                      
