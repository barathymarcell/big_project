                     ...
                     <div class="row-fluid">
					    <!-- breadcrumb -->
					     ...
					     <ul class="breadcrumb">
							...
							<li><a href="#"><b>Letölthető anyagok</b></a></li>
						</ul>
						 <!-- end breadcrumb -->
                        ...
                        <div id="block_bg" class="block">
							...
							Összes kijelölése <input type="checkbox"  name="selectAll" id="checkAll" />
								...
								<?php
									...
									$count = mysqli_num_rows($query);	
								if ($count == '0'){ ?>
								<div class="alert alert-info"><i class="icon-info-sign"></i> Jelenleg nincsenek letölthető tananyagok feltölve.</div>
								<?php
								}else{
								?>
									...
									<a data-toggle="modal" href="#user_delete" id="delete"  class="btn btn-info" name=""><i class="icon-copy"></i> Kijelölt elemek másolása a hátizsákba</a>
