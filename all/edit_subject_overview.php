                     ...
                     <div class="row-fluid">
					  <!-- breadcrumb -->
					     ...
					     <ul class="breadcrumb">
							...
							<li><a href="#"><b>Tantárgy Áttekintő</b></a></li>
						</ul>
						 <!-- end breadcrumb -->
                        ...
                        <div id="block_bg" class="block">
                            <div class="navbar navbar-inner block-header">
								...
								<a href="subject_overview.php<?php echo '?id='.$get_id; ?>" class="btn btn-success"><i class="icon-arrow-left"></i> Visszalépés</a>
								</div>
                            </div>
								...
								?>
														<form class="form-horizontal" method="post">
																<div class="control-group">
																	<label class="control-label" for="inputPassword">Tantárgy Összefoglaló:</label>
																	<div class="controls">
