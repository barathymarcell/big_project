                ...
                <div class="span9" id="content">
                     <div class="row-fluid">
						<div class="pull-right">
							<a href="add_student.php<?php echo '?id='.$get_id; ?>" class="btn btn-info"><i class="icon-plus-sign"></i> Hallgató hozzáadása</a>
							<a onclick="window.open('print_student.php<?php echo '?id='.$get_id; ?>')"  class="btn btn-success"><i class="icon-list"></i> Hallgatók listája</a>
						</div>
                                ...
                                <div class="span12">
									<ul	 id="da-thumbs" class="da-thumbs">
											...
											<li id="del<?php echo $id; ?>">
													...
													<a  href="#<?php echo $id; ?>" data-toggle="modal"><i class="icon-trash"></i> Eltávolítás</a>	
											</li>
													...
													$(document).ready( function() {
														...
														var id = $(this).attr("id");
															...
															success: function(html){
																...
																$('#'+id).modal('hide');
																$.jGrowl("A hallgató sikeresen eltávolítva!", { header: 'Hallgató Eltávolítva!' });
															}
															}); 	
															return false;
														});				
