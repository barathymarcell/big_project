            ...
            <div class="row-fluid">
                ...
                <div class="span4" id="content">
                     <div class="row-fluid">
                        ...
                        <div id="block_bg" class="block">
                            <div class="navbar navbar-inner block-header">
							    <div id="" class="muted pull-left"><h4> Feladatok osztályázatai</h4></div>
							</div>
                     ...
                     <div class="row-fluid">
                        ...
                        <div id="block_bg" class="block">
                            <div class="navbar navbar-inner block-header">
							    <div id="" class="muted pull-left"><h4> Gyakorló Kvízek</h4></div>
							</div>
                            <div class="block-content collapse in">
                                <div class="span12">
								...
								<table cellpadding="0" cellspacing="0" border="0" class="table" id="">
										<thead>
												...
												<th>Kvíz</th>
												<th>Leírás</th>
												<th>Kvíz időtartama (percekben)</th>
												<th></th>
												</tr>
										</thead>
										<tbody>
									...
									?>          
										...
										<b>Already Taken Score <?php echo $grade; ?></b>
														...
														$(document).ready(function(){
															$('#<?php echo $id; ?>Oldd meg ezt a kvízt').tooltip('show');
															$('#<?php echo $id; ?>Oldd meg ezt a kvízt').tooltip('hide');
														});
														</script>										 
										</tr>
										<?php } ?>
