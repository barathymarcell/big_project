                     ...
                     <div class="row-fluid">
					    <!-- breadcrumb -->
					     ...
					     <ul class="breadcrumb">
							...
							<li><a href="#"><b>Gyakorló kvíz</b></a></li>
						</ul>
						 <!-- end breadcrumb -->
...
?>
										...
										setInterval(function(){
											...
											if(timer == 0){
												...
												jQuery("#msg").text("Lejárt az idő!\Küldjék el válaszaikat!");
											} else {
...
?>
	<input name="q-<?php echo $roww['quiz_question_id'];?>" value="True" type="radio"> Igaz &nbsp; | &nbsp;<input name="q-<?php echo $roww['quiz_question_id'];?>" value="False" type="radio"> Hamás
<?php
...
?>
<br/>
<button onclick="return false;" qn="<?php echo $x;?>" class="nextq btn btn-success" id="next_<?php echo $x;?>">KÖVETKEZŐ KÉRDÉS <i class="icon-arrow-right"></i> </button>
...
<td></td>
<td>
<button class="btn btn-info" id="submit-test" name="submit_answer"><i class="icon-check"></i> Válasz elküldése</button>
