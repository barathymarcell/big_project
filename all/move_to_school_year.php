				<!-- user delete modal -->
					...
					<h3 id="myModalLabel">Állomány másolása?</h3>
					</div>
					<div class="modal-body">
				
										<center>
										<div class="control-group">
											<label>Másolás az adott csoport tanévébe:</label>
                                          <div class="controls">
											...
											<div class="control-group">
                                          <div class="controls">
										  	<button name="delete_user" class="btn btn-danger"><i class="icon-copy"></i> Másolás</button>
                                          </div>
                                        </div>
										</center>
										...
										<div class="control-group">
                                   		...
                                   		<div class="control-group">
                                          <div class="controls">
										  	<button name="copy" class="btn btn-info"><i class="icon-copy"></i> Másolás a hátizsákba</button>
                                          </div>
                                        </div>
                                        </div>
										...
										<div class="control-group">
                                          ...
                                          <div class="controls">
											...
											<?php } ?>
										  	...
										  	<button name="share" class="btn btn-success"><i class="icon-copy"></i> Megosztás</button>
                                          </div>
                                        </div>
                                        </div>
