                     ...
                     <div class="row-fluid">
					    <!-- breadcrumb -->	
									<ul class="breadcrumb">
										...
										?>
										<li><a href="#"><b>Csoportom</b></a><span class="divider">/</span></li>
										<li><a href="#">Tanév: <?php echo $school_year_query_row['school_year']; ?></a><span class="divider">/</span></li>
										<li><a href="#"><b>Kvízkérdés</b></a></li>
									</ul>
						 <!-- end breadcrumb -->
                        <!-- block -->
                        <div id="block_bg" class="block">
                            <div class="navbar navbar-inner block-header">
								...
								<a href="quiz_question.php<?php echo '?id='.$get_id; ?>" class="btn btn-success"><i class="icon-arrow-left"></i> Visszalépés</a>
								</div>
                            </div>
                            <div class="block-content collapse in">
							    ...
							    <form class="form-horizontal" method="post">
								        <div class="control-group">
											<label class="control-label" for="inputPassword">Kérdés</label>
											<div class="controls">
										...
										<div class="control-group">
											<label class="control-label" for="inputEmail">Kérdés típusa:</label>
											<div class="controls">			
...
<div id="opt12">
	<input name="correctt" <?php if($row['answer'] == 'True'){ echo 'checked'; }?> value="t" type="radio">Igaz<br /><br />
	<input name="correctt" <?php if($row['answer'] == 'False'){ echo 'checked'; }?> value="f" type="radio">Hamis<br /><br />
</div>
											</div>
										</div>
						...
						<div class="control-group">
										...
										<button name="save" type="submit" class="btn btn-info"><i class="icon-save"></i> Mentés</button>
										</div>
										</div>		
