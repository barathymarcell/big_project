                        ...
                        <div id="block_bg" class="block">
                            ...
                            <div class="block-content collapse in">
							    ...
							    <form class="form-horizontal" method="post">
										...
										<div class="control-group">
											<label class="control-label" for="inputEmail">Pontszám(ok):</label>
											<div class="controls">
										...
										<div class="control-group">
											<label class="control-label" for="inputEmail">Kérdés típus:</label>
											<div class="controls">			
										...
										<div class="control-group">
											...
											<div class="controls">			
													...
													<div id="opt12">
														<input name="correctt" value="True" type="radio">Igaz<br /><br />
														<input name="correctt"  value="False" type="radio">Hamis<br /><br />
													</div>
											</div>
										</div>
