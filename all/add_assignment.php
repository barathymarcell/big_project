        ...
        <div class="container-fluid">
                            ...
                            <div class="block-content collapse in">
                                <div class="span4">
										<form class="" id="add_downloadble" method="post" enctype="multipart/form-data" name="upload" >
												...
												<div class="control-group">
													<div class="controls">
														<input type="text" name="name" Placeholder="Állomány neve"  class="input">
													</div>
												</div>
												<div class="control-group">
													<div class="controls">
													<textarea id="assigntextare" placeholder="Leírás" name="desc" required></textarea>
													</div>
												</div>
			...
			jQuery(document).ready(function($){
				$("#add_downloadble").submit(function(e){
					$.jGrowl("kérjük várjon......", { sticky: true });
					e.preventDefault();
					var _this = $(e.target);
			...
			<div class="alert alert-info">Ellenőrizze az Osztályt, ahová a fájlt szeretné elhelyezni.</div>
