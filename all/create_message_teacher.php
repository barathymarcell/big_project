                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
									<ul class="nav nav-tabs">
										<li>
											<a href="teacher_message.php">Oktató számára</a>
										</li>
										<li class="active"><a href="teacher_message_teacher.php">Hallgató számára</a></li>
									</ul>
								...
								<form method="post" id="send_message_student">
									<div class="control-group">
										...
										<div class="control-group">
                                          <div class="controls">
												<button  class="btn btn-info"><i class="icon-envelope-alt"></i> Küldés </button>
