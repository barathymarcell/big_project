					...
					$('.notification').click(function() {
						...
						switch($id) {
							case 'notification-sticky':
								$.jGrowl("Ragaszd ezt fel!", { sticky: true });
							break;
							case 'notification-header':
								$.jGrowl("Egy üzenet fejleccél csatolva.", { header: 'Fontos!' });
							break;
							default:
								$.jGrowl("Üdvözlünk!");
							break;
        ...
        $(function() {
            ...
            $( 'textarea#ckeditor_standard' ).ckeditor({width:'98%', height: '150px', toolbar: [
				{ name: 'document', items: [ 'Forrás', '-', 'Új oldal', 'Előnézet', '-', 'Sablonok' ] },	// Defines toolbar group with name (used to create voice label) and items in 3 subgroups.
				[ 'Kivágás', 'Másolás', 'Beillesztés', 'Szöveg beillesztése', 'Szó beillesztése', '-', 'Visszavonás', 'Újrahívás' ],			// Defines toolbar group without name.
