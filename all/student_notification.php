        ...
        <div class="container-fluid">
            <div class="row-fluid">
                ...
                <div class="span9" id="content">
                     <div class="row-fluid">
  					...
  					<form action="read.php" method="post">
						<?php if($not_read == '0'){
							...
							<button id="delete"  class="btn btn-info" name="read"><i class="icon-check"></i> Elolvasás</button>
					...
					?>
					<div class="alert alert-info"><strong><i class="icon-info-sign"></i> Nincs megjeleníthető értesítés.</strong></div>
					<?php
					}
					?>
