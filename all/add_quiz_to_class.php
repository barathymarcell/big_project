                                ...
                                <div class="span12">
									...
									<a href="teacher_quiz.php" class="btn btn-info"><i class="icon-arrow-left"></i> Visszalépés</a>
										...
										<div class="control-group">
											<label class="control-label" for="inputEmail">Kvíz</label>
											<div class="controls">
											<select name="quiz_id">
											<option></option>
										...
										<div class="control-group">
											<label class="control-label" for="inputPassword">Hátralévő idő (percekben)</label>
											<div class="controls">
											<input type="text" class="span3" name="time" id="inputPassword" placeholder="Idő" required>
											</div>
										</div>
					...
					<?php } ?>
										...
										if (isset($_POST['save'])){
											...
											$id=$_POST['selector'];
													...
													$name_notification  = 'Gyakorló Kvíz állományának hozzáadása';
