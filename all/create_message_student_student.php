				      ...
				      <!-- block -->
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div id="" class="muted pull-left"><h4><i class="icon-pencil"></i> Üzenet létrehozása</h4></div>
                            </div>
                            <div class="block-content collapse in">
                                <div class="span12">
								    ...
								    <ul class="nav nav-tabs">
										<li>
											<a href="student_message.php">Oktató számára</a>
										</li>
										<li class="active"><a href="student_message_student.php">Hallgató számára</a></li>
								...
								<form method="post" id="send_message_student">
									<div class="control-group">
										...
										<div class="control-group">
                                          <div class="controls">
												<button  class="btn btn-success"><i class="icon-envelope-alt"></i> Küldés </button>
												...
												<script>
															...
															jQuery("#send_message_student").submit(function(e){
																	...
																	$.ajax({
																		...
																		$.jGrowl("Az üzenet sikeresen elküldve!", { header: 'Üzenet továbbítva!' });
																		var delay = 2000;
