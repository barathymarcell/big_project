                        ...
                        <div id="block_bg" class="block">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
									...
									<a href="teacher_quiz.php" class="btn btn-success"><i class="icon-arrow-left"></i> Visszalépés</a>
									<a href="add_question.php<?php echo '?id='.$get_id; ?>" class="btn btn-info"><i class="icon-plus-sign"></i> Kérdés hozzáadása</a>
									</div>
