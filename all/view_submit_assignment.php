					   ...
					   <!-- breadcrumb -->
                        ...
                        <div id="block_bg" class="block">
                            <div class="navbar navbar-inner block-header">
                                <div id="" class="muted pull-right"><a href="assignment.php<?php echo '?id='.$get_id; ?>"><i class="icon-arrow-left"></i> Visszalépés</a></div>
                            </div>
                            <div class="block-content collapse in">
                                <div class="span12">
									...
									?>
									<div class="alert alert-info">Feladat elküldése az alábbi helyre: <?php echo $row1['fname']; ?></div>
				...
				<table cellpadding="0" cellspacing="0" border="0" class="table" id="">
									...
									?>                              
										<tr>
										 ...
										 <button name="save" class="btn btn-success" id="btn_s"><i class="icon-save"></i> Mentés</button>
										 </form>
										 </td>                                                                        
                                </tr>
