 ...
 ?>
                     ...
                     <div class="row-fluid">
					  <!-- breadcrumb -->
					     ...
					     <ul class="breadcrumb">
							...
							<li><a href="#"><b>Közlemények</b></a></li>
						</ul>
						 <!-- end breadcrumb -->
                        ...
                        <div id="block_bg" class="block">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
								<a href="announcements.php<?php echo '?id='.$get_id; ?>"><i class="icon-arrow-left icon-large"></i> Visszalépés</a>
								<br>
								<br>
								<form method="post">
									 <?php
								...
								<br>
								<button name="post" class="btn btn-info"><i class="icon-check icon-large"></i> Közzététel</button>
								</form>
                                </div>
	...
	$(document).ready( function() {
		...
		var id = $(this).attr("id");
			...
			$('#'+id).modal('hide');
			$.jGrowl("A művelet sikeresen végrehajtva!", { header: 'Adat törölve!' });
