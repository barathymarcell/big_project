                     ...
                     <div class="row-fluid">
					    <!-- breadcrumb -->
					     ...
					     <ul class="breadcrumb">
							...
							<li><a href="#"><b>Gyakorló kví</b></a></li>
						</ul>
						 <!-- end breadcrumb -->
                                ...
                                <div class="span12">
									...
									?>                              
										<tr>                     
                                         ...
                                         <td width="200">
										<?php if ($grade == ""){ ?>
											<a  data-placement="bottom" title="Végezze el ezt a kvízt" id="<?php echo $id; ?>Download" href="take_test.php<?php echo '?id='.$get_id ?>&<?php echo 'class_quiz_id='.$id; ?>&<?php echo 'test=ok' ?>&<?php echo 'quiz_id='.$quiz_id; ?>&<?php echo 'quiz_time='.$quiz_time;	 ?>"><i class="icon-check icon-large"></i> Take This Quiz</a>
										<?php }else{ ?>
										...
										<?php } ?>
														...
														$(document).ready(function(){
															$('#<?php echo $id; ?>Végezze el ezt a kvízt').tooltip('show');
															$('#<?php echo $id; ?>Végezze el ezt a kvízt').tooltip('hide');
														});
														</script>										 
										</tr>
						 <?php } ?>
