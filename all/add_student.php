        ...
        <div class="container-fluid">
            <div class="row-fluid">
				...
				<div class="pull-right">
							<a href="my_students.php<?php echo '?id='.$get_id; ?>" class="btn btn-info"><i class="icon-arrow-left"></i> Visszalépés</a>
						</div>
					     ...
					     <ul class="breadcrumb">
							...
							<li><a href="#">Hallgatóim: </a><span class="divider">/</span></li>
							<li><a href="#"><b>Hallgató hozzáadása</b></a></li>
						</ul>
                        ...
                        <div id="block_bg" class="block">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
									<form method="post" action="">
										...
										<button name="submit" type="submit" class="btn btn-info"><i class="icon-save"></i>&nbsp;Hallgató hozzáadása</button>
												<br>
												<br>
						 ...
						 <thead>
                                ...
                                <tr>
                                    ...
                                    <th>Kép</th>
                                    <th>Név</th>
                                    <th>Csoport tanévei és beoszátsai</th>
...
if (isset($_POST['submit'])){
	...
	$count = mysqli_num_rows($query); 
 	...
 	if ($count > 0){ ?>
	<script>
	 alert('Már létezik ilyen hallgató a csoportban!'); 
	</script>
	<script>
