				<!-- user delete modal -->
					...
					<p>Biztosan törölné szeretné az általa kiválasztott állományt?.</p>
					</div>
					</div>
					<div class="modal-footer">
					<button class="btn" data-dismiss="modal" aria-hidden="true"><i class="icon-remove icon-large"></i> Bezárás</button>
					<button name="backup_delete" class="btn btn-danger"><i class="icon-check icon-large"></i> Törlés</button>
					</div>
					</div>